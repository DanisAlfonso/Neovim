...
require("lazy").setup({
	...
	{ -- LSP Configuration & Plugins
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				group = vim.api.nvim_create_augroup("danny-lsp-attach", { clear = true }),
				callback = function(event)
					...
					if client and client.server_capabilities.documentHighlightProvider then
						local highlight_augroup = vim.api.nvim_create_augroup("danny-lsp-highlight", { clear = false })
						...
						vim.api.nvim_create_autocmd("LspDetach", {
							group = vim.api.nvim_create_augroup("danny-lsp-detach", { clear = true }),
							callback = function(event2)
								vim.lsp.buf.clear_references()
								vim.api.nvim_clear_autocmds({ group = "danny-lsp-highlight", buffer = event2.buf })
							end,
						})
					end
	...
	-- The following two comments only work if you have downloaded the danny repo, not just copy pasted the
	-- init.lua. If you want these files, they are in the repository, so you can just download them and
	-- place them in the correct locations.

	-- NOTE: Next step on your Neovim journey: Add/Configure additional plugins for danny
	--
